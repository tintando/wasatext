...
type WebAPIConfiguration struct {
	...
	Photos struct {
		BasePath     string `conf:"default:./photos"`
		UsersPath    string `conf:"default:./photos/users"`
		GroupsPath   string `conf:"default:./photos/groups"`
		MessagesPath string `conf:"default:./photos/messages"`
	}
}
